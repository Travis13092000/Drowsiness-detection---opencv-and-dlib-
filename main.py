...
dlib_facelandmark = dlib.shape_predictor("C:\\Users\\travi\\OneDrive\\Desktop\\project\\face\\shape_predictor_81_face_landmarks.dat")
...
while True:
	...
	for face in faces:
		...
		if Eye_Rat < 0.25:
			...
			cv2.putText(frame, "Alert!!!! WAKE UP!!! WAKE UP!!!", (50, 450),
